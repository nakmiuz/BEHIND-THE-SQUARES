...
Description: A small quiz game. The image is hidden behind a grid of squares. The player clicks on the squares to reveal parts of the image and tries to guess what's in the picture.
Key Mechanics:
